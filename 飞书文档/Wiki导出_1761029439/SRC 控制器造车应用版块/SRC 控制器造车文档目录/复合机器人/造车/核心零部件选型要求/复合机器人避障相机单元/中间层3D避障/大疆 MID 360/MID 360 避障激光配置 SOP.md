...
### 图 2.1 避障相机模型文件配置 SOP
首先进入 camera，复制并添加新的 camera，重命名设备并启用，随后按照如下流程配置相机：
...
## 图 2.5 配置相机视场角
配置相机 id、配置安装位姿、选择是否正装：根据实际安装位置填写安装位姿参数，并选择是否正装。
1703729988042-ef8b1a4a-15ff-478d-aa09-074edc75d587.png

### 图 2.6 配置相机 id、配置安装位姿、选择是否正装
...
如配置正确可在地图窗口看到深度相机识别到的障碍物点，如图 3.1 所示；
